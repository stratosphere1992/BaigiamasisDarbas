<template>
    ...
    <div class="d-flex flex-row align-items-center flex-wrap mt-2">
        <div class="col-md-4">
            <select class="form-select" name="category_id" v-model="category" @change="getSubCategories()">
        ...
        <div class="col-md-4">
            <select class="form-select" name="subcategory_id" v-model="subcategory" @change="getChildCategories()">
