...
@section('content')
    ...
    <div class="container" >
        <div class="row ">
            <div class="col-md-3">
                <div class="card" >
                    <div class="card-header text-white text-center" style="background-color: SeaGreen;">Filter</div>
                    <div class="card-body">
                ...
                <div class="row">
                    @forelse($advertisements as $advertisement)
                        ...
                        <a href="{{route('product.view',[$advertisement->id,$advertisement->slug])}}">
                            ...
                            <p class="text-center  card-footer" style="color: blue;">{{$advertisement->name}}/EUR {{$advertisement->price}}</p>
                        </a>
                        </div>
